...
async function getBlogDetailData(id: string) {
...
export default async function BlogDetail({
  ...
  const blogData = await getBlogDetailData(params.id);
  ...
  return (
    <>
      ...
      <PageTitle title={`Store - ${blogData.title}`} />
